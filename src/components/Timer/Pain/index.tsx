...
import { Box, Button, Slider, SliderFilledTrack, SliderThumb, SliderTrack, Tooltip } from '@chakra-ui/react'
...
const PainSlider: React.FC<Props> = ({updateGraph, setUpdateGraph, addPainActiveSess}) => {
